...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\sffamily\textcolor{GRIGIOSCURO}{EasyEvent \textperiodcentered{} V5}}
...
\titleformat{\chapter}[display]
  ...
  {\sffamily\small\mdseries\color{GRIGIOSCURO}\textsc{Capitolo}~\thechapter}
  {4pt}
  {}
  [\vspace{2pt}\textcolor{BLU}{\rule{\textwidth}{1.5pt}}]
...
\usepackage[
  ...
  pdfauthor={Riccardo Marini, Raffaele Principe – Ingegneria del Software A.A. 2025-2026},
...
\author{%
  {\sffamily Riccardo Marini (matr.\ 746230)}\\
  {\sffamily Raffaele Principe (matr.\ 749438)}\\[4pt]
...
\begin{titlepage}
  ...
  \begin{tabular}{ll}
    ...
    \midrule
    \sffamily\textbf{Autori} & \sffamily Riccardo Marini \quad matr.\ 746230 \\
                              & \sffamily Raffaele Principe \quad matr.\ 749438 \\
    \bottomrule
  \end{tabular}
  \vspace{1.5cm}
\end{titlepage}
