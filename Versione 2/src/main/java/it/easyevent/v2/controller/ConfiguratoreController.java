 ...
 * 
 * Le proposte create in sessione (stato BOZZA o VALIDA) vengono scartate al
 * logout se non pubblicate, come da specifica.
 *
...
public class ConfiguratoreController {
    ...
    /**
     * Effettua il logout: scarta le proposte di sessione non pubblicate.
     */
    public void logout() {
        proposteSessione.clear(); // proposte non pubblicate vengono scartate
    ...
    // ================================================================
    // PROPOSTE – GESTIONE DI SESSIONE 
    // ================================================================
    /**
     * Crea una nuova proposta per la categoria indicata e la aggiunge alla
     * lista di sessione. Lo snapshot dei campi rispecchia la configurazione
     * corrente al momento della creazione.
     *
     * @param nomeCategoria categoria della proposta, deve esistere
     * @return la Proposta creata, o null se la categoria non esiste o non
     * loggato
     */
    ...
    /**
     * Tenta di pubblicare in bacheca una proposta della sessione corrente. La
     * proposta deve essere in stato VALIDA. Se la pubblicazione ha successo, la
     * proposta viene rimossa dalla sessione e aggiunta alla bacheca
     * (persistita).
     *
    ...
    /**
     * @return lista non modificabile delle proposte create nella sessione
     * corrente (stato BOZZA o VALIDA, non ancora pubblicate)
     */
