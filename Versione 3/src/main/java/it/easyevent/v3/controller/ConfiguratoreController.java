...
public class ConfiguratoreController {
    ...
    /**
     * [NUOVO CASO D'USO V3 – UC-CONF-07: Visualizza archivio proposte]
     *
     ...
     * ANNULLATA, CONCLUSA) piu' quelle ancora APERTE.
     * Solo i configuratori possono accedere all'archivio; i fruitori vedono
     * solo la bacheca (proposte APERTE).
     *
    ...
    /**
     * Aggiorna automaticamente gli stati delle proposte in archivio
     * in base alla data odierna. Da chiamare all'avvio di ogni sessione.
     *
     * Se il salvataggio fallisce, viene eseguito un rollback ricaricando
     * i dati dal file su disco (che non e' stato modificato), in modo da
     * ripristinare la coerenza tra memoria e persistenza. Senza rollback,
     * lo stato in memoria sarebbe gia' aggiornato (proposte transitate,
     * notifiche depositate) ma il file sarebbe rimasto alla versione
     * precedente: al prossimo avvio le transizioni verrebbero ri-eseguite
     * producendo notifiche duplicate.
     *
