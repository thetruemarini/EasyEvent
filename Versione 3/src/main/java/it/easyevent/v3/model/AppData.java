...
public class AppData {
     ...
     * @throws IllegalArgumentException se fruitore e' null o username gia' in
     * uso
     */
    ...
    /**
     * @deprecated Usare esisteUsernameGlobale. Mantenuto per compatibilita'
     * V1/V2.
     */
    @Deprecated
    ...
    /**
     * @return lista non modificabile di TUTTE le proposte pubblicate (archivio
     * completo)
     */
    ...
    /**
     * Rimuove una proposta dall'archivio dato il suo ID. Usato esclusivamente
     * per rollback in caso di errore di salvataggio dopo
     * aggiungiPropostaAperta().
     *
     ...
     *
     * Logica: 
     * - APERTA con oggi > Termine iscrizione: se aderenti >= Numero
     * partecipanti -> CONFERMATA (notifiche di conferma agli aderenti)
     * altrimenti -> ANNULLATA (notifiche di annullamento agli aderenti) 
     * - CONFERMATA con oggi > Data conclusiva: -> CONCLUSA (nessuna notifica)
     *
     * Le notifiche vengono depositate negli spazi personali dei fruitori
     * aderenti.
     *
