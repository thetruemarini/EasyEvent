...
public class Proposta {
    ...
    /**
     * Costruttore per la deserializzazione (V3).
     * Applica le stesse precondizioni del costruttore interattivo per difendersi
     * da JSON corrotti che potrebbero produrre NullPointerException a runtime.
     */
    public Proposta(int id, String nomeCategoria, String usernameCreatore,
                    LinkedHashMap<String, Boolean> campiOrdinati,
    ...
    /**
     * Riporta la proposta allo stato VALIDA annullando una pubblicazione fallita.
     * Da usare ESCLUSIVAMENTE come rollback quando pubblicaInBacheca() ha avuto
     * successo ma il salvataggio su disco ha fallito.
     *
     ...
     * Registra il cambio nello storico.
     *
     * Transizioni valide in V3:
     *   APERTA     -> CONFERMATA
     *   APERTA     -> ANNULLATA
     *   CONFERMATA -> CONCLUSA
     *
     ...
     * @return stringa vuota se l'iscrizione e' avvenuta, messaggio di errore altrimenti
     */
    ...
    /** @return il "Termine ultimo di iscrizione" come LocalDate, o null se non compilato/invalido */
    public LocalDate getTermineIscrizione() {
        return parseDateSafe(getValore(CAMPO_TERMINE_ISCRIZIONE));
    }

    /** @return la "Data conclusiva" come LocalDate, o null se non compilata/invalida */
     ...
     *  un intero valido o non e' compilato.
     *  Nota: una proposta con questo campo non valorizzato non dovrebbe mai essere
     *  pubblicata (e' obbligatorio e la validazione lo impedirebbe). Il valore -1
     *  viene usato come sentinella di errore: aggiornaTransizioni() in AppData lo
     *  tratta come proposta non confermabile (transita in ANNULLATA), rendendo
     *  visibile il dato corrotto senza silenziarlo.
     */
