 ...
 *     aperta (nuovo caso d'uso V4, UC-FUIT-06), con possibilita' di re-iscrizione.
 *
...
public class FruitoreController {
    ...
    public boolean esisteFruitore(String username) { return appData.getFruitore(username) != null; }
    ...
    public String aderisci(int idProposta) {
        ...
        if (p == null) return "Proposta non trovata o non piu' aperta (ID: " + idProposta + ").";
     ...
     * [NUOVO V4 – UC-FUIT-06]
     *
     * La disdetta e' consentita solo fino alle ore 23:59 del "Termine ultimo
     * di iscrizione". L'applicazione non gestisce l'ora: la verifica e' sul
     * giorno (oggi <= termine).
     *
     ...
     *
     * @param idProposta ID della proposta
     * @return stringa vuota se la disdetta e' avvenuta, messaggio di errore altrimenti
     */
    ...
    public String cancellaNotifica(int idNotifica) {
        ...
        if (daRimuovere == null) return "Notifica non trovata con ID: " + idNotifica;
