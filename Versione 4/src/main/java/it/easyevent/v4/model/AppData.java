...
public class AppData {
    ...
    @Deprecated
    public boolean esisteUsername(String username) { return esisteUsernameGlobale(username); }
    ...
    public boolean modificaObbligatorietaCampoComune(String nomeCampo, boolean obbligatorio) {
        for (Campo c : campiComuni) {
            if (c.getNome().equalsIgnoreCase(nomeCampo)) { c.setObbligatorio(obbligatorio); return true; }
        }
        return false;
    }
     ...
     * (proposta.verificaRitiroConsentito(oggi)) prima di invocare questo metodo.
     *
     * @param proposta la proposta da ritirare, non null, stato APERTA o CONFERMATA
    ...
    public void ritirareProposta(Proposta proposta, LocalDate oggi) {
        ...
        assert proposta.getStato() == StatoProposta.RITIRATA
            : "Postcondizione violata: stato non RITIRATA dopo ritirareProposta";
    }
    ...
    public void setCampiComuni(List<Campo> campiComuni)       { this.campiComuni = new ArrayList<>(campiComuni); }
    public void setCategorie(List<Categoria> categorie)       { this.categorie = new ArrayList<>(categorie); }
    public void setConfiguratori(List<Configuratore> list)    { this.configuratori = new ArrayList<>(list); }
    public void setFruitori(List<Fruitore> list)              { this.fruitori = new ArrayList<>(list); }
