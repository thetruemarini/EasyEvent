...
public class Proposta {
     ...
     * RITIRATA.
     *
     * Transizioni valide: APERTA -> CONFERMATA (automatica, V3) APERTA ->
     * ANNULLATA (automatica, V3) CONFERMATA -> CONCLUSA (automatica, V3) APERTA
     * -> RITIRATA (manuale configuratore, V4) CONFERMATA -> RITIRATA (manuale
     * configuratore, V4)
     */
     ...
     *
     * Precondizioni: - stato == APERTA - isIscrizioneAperta(oggi) == true -
     * fruitore non gia' iscritto - aderenti.size() < numMaxPartecipanti
     */
    ...
    /**
     * Rimuove l'iscrizione di un fruitore dalla proposta. [NUOVO V4] Un
     * fruitore puo' disdire la propria iscrizione fino al termine.
     *
     * Postcondizione: se la rimozione ha successo, il fruitore NON e' piu'
     * nell'elenco degli aderenti, ma potra' re-iscriversi (rispettando il
     * termine).
     *
     * @param usernameF username del fruitore
     * @param oggi data corrente
    ...
    // ================================================================
    /**
     * Verifica se il configuratore puo' ritirare la proposta nella data
     * indicata.
     *
     * Il ritiro e' consentito (spec. V4) fino alle 23:59 del giorno PRECEDENTE
     * alla data "Data" dell'iniziativa. L'applicazione non gestisce l'ora,
     * quindi: la condizione diventa: oggi < getData() (strettamente minore).
     *
     * Precondizione: la proposta deve essere in stato APERTA o CONFERMATA.
     *
     * @param oggi data corrente
     * @return stringa vuota se il ritiro e' consentito, messaggio di errore
     * altrimenti
     */
