...
public class BatchRisultato {
    ...
    public void aggiungiSuccesso(String messaggio) {
        if (messaggio == null) messaggio = "(operazione completata)";
    ...
    public void aggiungiWarning(int riga, String messaggio) {
        if (messaggio == null) messaggio = "(warning senza descrizione)";
    ...
    public void aggiungiErrore(int riga, String messaggio) {
        if (messaggio == null) messaggio = "(errore senza descrizione)";
    ...
    public int getRigheTotali()         { return righeTotali; }
    public int getNumSuccessi()         { return successi.size(); }
    public int getNumWarnings()         { return warnings.size(); }
    public int getNumErrori()           { return errori.size(); }

    public List<String> getSuccessi()   { return Collections.unmodifiableList(successi); }
    public List<String> getWarnings()   { return Collections.unmodifiableList(warnings); }
    public List<String> getErrori()     { return Collections.unmodifiableList(errori); }

    /** @return true se non ci sono errori (warning ammessi) */
    public boolean isSenzaErrori()      { return errori.isEmpty(); }

    /** @return true se non ci sono né errori né warning */
    public boolean isCompletamenteOk()  { return errori.isEmpty() && warnings.isEmpty(); }
    ...
    /**
     * Aggiunge i risultati di un altro BatchRisultato a questo.
     * Usato quando si importano più file in sequenza.
     *
